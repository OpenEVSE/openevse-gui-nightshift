...
// `requires` gates on a device-config capability key being *truthy*, or on
// any one of a list of keys; `requiresKey` gates on that key merely being
// *present*, for capabilities whose own off switch lives on the page they
// would hide; `labs` gates on the client-side OpenEVSE Labs switch
